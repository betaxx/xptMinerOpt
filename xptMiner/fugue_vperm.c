...
void Compress256(hashState *ctx, uint64_t *pmsg, unsigned int uBlockCount)
{
...
void Final256(hashState *ctx, void *hashval)
{
...
void Compress384(hashState *ctx, const uint64_t* pmsg, unsigned int uBlockCount)
{
//	unsigned int r, b, i, j;
//	__m128i t1, t2, t3, s1, s2, s3, k;
//	__m128i _s0, _s1, _s2, _s3, _s4, _s5, _s6, _s7, _s8, _s9;
...
void Final384(hashState *ctx, void *hashval)
{
...
void Compress512(hashState *ctx, uint64_t* pmsg, unsigned int uBlockCount)
{
//	unsigned int r, b, i, j;
//	__m128i t1, t2, t3, s1, s2, s3, k;
//	__m128i _s0, _s1, _s2, _s3, _s4, _s5, _s6, _s7, _s8, _s9;
...
void Final512(hashState *ctx, void *hashval)
{
	unsigned int i, col[36], block[4], base;
	__m128i t1, t2;
	__m128i r0, _t0, _t1, _t2, _t3;
...
void Update(hashState *state, uint64_t *data, DataLength databitlen)
{
	...
	if(state->uBufferBytes + uByteLength >= state->uBlockLength)
	{
		...
		{
			if(state->uHashSize == 256)
				Compress256(state, (uint64_t*) data, uBlockCount);
			else if(state->uHashSize == 384)
				Compress384(state, (uint64_t*) data, uBlockCount);
			else
				Compress512(state, (uint64_t*) data, uBlockCount);
